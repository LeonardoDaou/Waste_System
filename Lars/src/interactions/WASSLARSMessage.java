...
@InteractionClass(name = "WASSLARSMessage")
public class WASSLARSMessage {
    ...
    public WASSLARSMessage() { }

    public WASSLARSMessage(String sender, String receiver, String messageType, String content) {
        this.sender = sender;
