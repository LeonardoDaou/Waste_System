...
@InteractionClass(name = "WASSWAPSMessage")
public class WASSWAPSMessage {
    ...
    public WASSWAPSMessage() { }

    public WASSWAPSMessage(String sender, String receiver, String messageType, String content) {
        this.sender = sender;
